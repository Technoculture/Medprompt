...
def store_correct_cot(
    questions: list[str], option_sets: list[str], answers: list[str]
) -> list[str]:
    train_set = []
...
>>>>>>> origin/dev
    ...
    trainset = store_correct_cot(
        train_questions, formatted_train_options, train_answers_id
    )
...
>>>>>>> origin/dev
    ...
    parser.add_argument(
        "--shots", type=int, default=5, help="Number of shots for knn fewshot."
    )
